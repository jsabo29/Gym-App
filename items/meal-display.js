...
export default function MealDisplay({index, calories, protein, date, onDelete, width}){
  ...
  return(
    <View style={[styles.wholeDiv, {width: width}]}>
      ...
      <View style={[styles.mainContainer, {justifyContent: 'center'}]}>
        <Text style={[styles.data]}>Calories: {calories}</Text>
        <Text style={[styles.data]}>Protein: {protein}g</Text>
      </View>}
    </View>
  )
}
